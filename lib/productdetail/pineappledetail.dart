                            ...
                            children: [
                              ...
                              IconButton(
                                  onPressed: () {
                                    ...
                                    if (offerpine[index]["isfavorite"] ==
                                        true) {
                                      setState(() {
                                        offerpine[index]['isfavorite'] =
                                            false;
                                        favoriteItem.removeWhere((element) =>
                                            element == offerpine[index]);
                                      });
                                    } else {
                                      setState(() {
                                        favoriteItem.add(offerpine[index]);
                                        offerpine[index]["isfavorite"] =
                                            true;
                                      });
                                    }
                                  ...
                                  icon: Icon(Icons.favorite,
                                      color: offerpine[index]["isfavorite"]
                                          ? Colors.red
                                          : Colors.grey))
                            ],
                          ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text("\$ ${offerpine[index]["price"]}",style: TextStyle(fontSize: 25),),
                                  ),
                                ),
                              ],
                            ),
                    ...
                    borderRadius: BorderRadius.all(Radius.circular(20)),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              if (offerpine[index]["cart"] == true) {
                                setState(() {
                                  offerpine[index]["cart"] = false;
                                  cartItem.removeWhere(
                                      (element) => element == offerpine[index]);
                                });
                              } else {
                                setState(() {
                                  cartItem.add(offerpine[index]);
                                  offerpine[index]["cart"] = true;
                                  cartItem.last["qty"] = 1;
                                });
                              }
                            },
