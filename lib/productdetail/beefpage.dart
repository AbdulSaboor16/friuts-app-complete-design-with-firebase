                            ...
                            children: [
                              ...
                              IconButton(
                                  onPressed: () {
                                    ...
                                    if (grocerbeef[index]["isfavorite"] ==
                                        true) {
                                      setState(() {
                                        grocerbeef[index]['isfavorite'] =
                                            false;
                                        favoriteItem.removeWhere((element) =>
                                            element == grocerbeef[index]);
                                      });
                                    } else {
                                      setState(() {
                                        favoriteItem.add(grocerbeef[index]);
                                        grocerbeef[index]["isfavorite"] =
                                            true;
                                      });
                                    }
                                  ...
                                  icon: Icon(Icons.favorite,
                                      color: grocerbeef[index]["isfavorite"]
                                          ? Colors.red
                                          : Colors.grey))
                            ],
                          ),
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              if (grocerbeef[index]["cart"] == true) {
                                setState(() {
                                  grocerbeef[index]["cart"] = false;
                                  cartItem.removeWhere(
                                      (element) => element == grocerbeef[index]);
                                });
                              } else {
                                setState(() {
                                  cartItem.add(grocerbeef[index]);
                                  grocerbeef[index]["cart"] = true;
                                  cartItem.last["qty"] = 1;
                                });
                              }
                            },
